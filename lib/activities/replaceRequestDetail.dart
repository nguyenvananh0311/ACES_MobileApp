...
class _GetReplaceRequestState extends State<GetReplaceRequestScreen> {
  ...
  Future<List<dynamic>> fetchData() async {
    return await Future.wait([
      ApiService().fetchReplaceRequest(
          widget.requestId, companyId) // example employee ID
    ]);
  }
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
        appBar: CustomAppBarScreen(
          title: localization!.replaceRequestDetail,
          isBack: true,
        ),
                ...
                child: Card(
                  ...
                  child: Padding(
                    ...
                    child: Column(
                      ...
                      children: <Widget>[
                        LeaveTypeSelector(
                            selectedLeaveType: replaceRequest!.isFromMorning
                                ? "Morning"
                                : "Afternoon",
                          ...
                          children: <Widget>[
                            ...
                            Text(
                              DateFormat('EEE dd MMMM y')
                                  .format(replaceRequest.fromDate),
                              style:
                        ...
                        LeaveTypeSelector(
                            selectedLeaveType: replaceRequest.isToAfternoon
                                ? "Afternoon"
                                : "Morning",
                            onChanged: (String? newValue) {},
                        ...
                        LeaveDetailItem(
                            ...
                            description:
                                "${replaceRequest.duration} ${localization.days}"),
                        LeaveDetailItem(
                            label: localization.phoneNumber,
                            description: replaceRequest.contactNumber),
                        Row(
                          children: <Widget>[
                            ...
                            const Spacer(),
                            Text(
                              replaceRequest.status.toString(),
                              style: TextStyle(
                                  fontWeight: FontWeight.bold,
                                  color: replaceRequest.status == "Approved"
                                      ? Colors.green
                                      : replaceRequest.status == "Rejected"
                                          ? Colors.red
                                          : Colors.orange),
                            ),
                          ],
                        ...
                        if (replaceRequest.updateByName != null)
                          LeaveDetailItem(
                              ...
                              description:
                                  replaceRequest.updateByName.toString()),
                        LeaveDetailItem(
                            label: localization.comment,
                            description: replaceRequest.comment != null
                                ? replaceRequest.comment.toString()
                                : ''),
                        LeaveDetailItem(
                            label: localization.reason,
                            description: replaceRequest.reason.toString()),
                        if (replaceRequest.fileName != null &&
                            replaceRequest.fileName != '')
                          Center(
                            child: CachedNetworkImage(
                              imageUrl:
                                  'https://203.176.128.5:5678/Images/Requests/${replaceRequest.fileName}',
